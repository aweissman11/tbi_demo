...
export const MapPin = ({ lat, lng }: MapPinProps) => {
  return (
    <div className="h-6 w-6">
      <div className="absolute top-0 left-0 h-2 w-2 rounded-full bg-black" />
      <span className="absolute top-0 left-0 h-2 w-2 animate-ping rounded-full bg-black opacity-75"></span>
      <img
        src="/logo.svg"
        alt="Logo"
        className="mt-[6px] ml-[6px] inline-block w-[50px]"
        width="20px"
      />
    </div>
  );
