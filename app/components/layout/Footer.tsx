    ...
    <footer className="bg-background-accent-base">
      ...
      <div className="mh-20 flex items-start justify-between bg-background-accent-primary p-6 leading-8 sm:items-center">
        ...
        <div className="flex items-center justify-center leading-8">
          {/**
           * We've added a language picker here to make it easier to switch between languages.
           * It redirects to the same page but with a different language as a subdomain.
           * eg https://en.deptagency.com/ or https://nl.deptagency.com/
           * Make sure set up DNS to support this before implementation.
